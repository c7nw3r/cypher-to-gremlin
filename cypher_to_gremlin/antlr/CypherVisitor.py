...
class CypherVisitor(ParseTreeVisitor):
    ...
    def visitOC_StringPredicateExpression(
    ...
    def visitOC_ListPredicateExpression(
    ...
    def visitOC_NullPredicateExpression(
    ...
    def visitOC_NonArithmeticOperatorExpression(
    ...
    def visitOC_ExistentialSubquery(
